      ...
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-3xl font-bold mt-4">
            <span className="text-dojo-blue">🧠</span> Concept Clinic
          </h1>
          <p className="text-dojo-muted mt-2">I describe a situation. You name the principle and how to apply it.</p>
        </div>
